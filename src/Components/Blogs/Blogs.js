...
const Blogs = () => {
    return (
        <div className="container mt-3 mb-5">
            ...
            <p>Firebase offers free authentication by email, password, and one-time password (OTP) for phone numbers. Remote Configuration, It allows you to change the UI and content of your app without having to republish it. Cloud Firestore, Cloud Functions, Hosting, Cloud Storage, Google Analytics, Predictions, Cloud Messaging, Dynamic Links, Remote Config are some services that firebase provide other than authentication.</p>
        </div>
    );
};
